<template>
  <div class="impressum-page">
    <div class="container py-5">
      ...
      <p>
        <a href="https://www.aekn.de/fileadmin/inhalte/pdf/arzt-und-recht/berufsrecht-niedersachsen/BO_komplett_01052020.pdf" target="_blank">Berufsordnung der
          Landesärztekammer Niedersachsen</a><br>
        <a href="https://www.bundesaerztekammer.de/fileadmin/user_upload/BAEK/Themen/Recht/_Bek_BAEK_Musterberufsordnung-AE.pdf"
          target="_blank">(Muster-)Berufsordnung für die in Deutschland tätigen Ärztinnen und Ärzte</a>
      </p>
      ...
      <h3>Bildnachweise</h3>
      <p>
        Die auf dieser Webseite verwendeten Bilder stammen von Reinald Habel.
      </p>
    </div>
  </div>
</template>
...
.impressum-page h1 {
  color: #005e7c;
  /* Passe die Farbe an dein Design an */
}
